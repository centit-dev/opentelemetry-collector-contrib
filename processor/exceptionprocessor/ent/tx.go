...
func (tx *Tx) init() {
	tx.ExceptionCategory = NewExceptionCategoryClient(tx.config)
	tx.ExceptionDefinition = NewExceptionDefinitionClient(tx.config)
}
...
// applies a query, for example: ExceptionCategory.QueryXXX(), the query will be executed
