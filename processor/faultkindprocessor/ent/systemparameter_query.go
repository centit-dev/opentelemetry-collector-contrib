...
func (spq *SystemParameterQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (spq *SystemParameterQuery) FirstIDX(ctx context.Context) string {
...
func (spq *SystemParameterQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (spq *SystemParameterQuery) OnlyIDX(ctx context.Context) string {
...
func (spq *SystemParameterQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (spq *SystemParameterQuery) IDsX(ctx context.Context) []string {
	ids, err := spq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(systemparameter.FieldValue).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (spq *SystemParameterQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(systemparameter.Table, systemparameter.Columns, sqlgraph.NewFieldSpec(systemparameter.FieldID, field.TypeString))
	_spec.From = spq.sql
