module github.com/open-telemetry/opentelemetry-collector-contrib/processor/apptypeprocessor
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/spangroup v0.88.0
