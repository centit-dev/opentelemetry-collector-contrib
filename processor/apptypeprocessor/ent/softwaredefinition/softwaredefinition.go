...
const (
	// Label holds the string label denoting the softwaredefinition type in the database.
	Label = "software_definition"
	...
	// Table holds the table name of the softwaredefinition in the database.
	Table = "tb_software_define"
)

// Columns holds all SQL columns for softwaredefinition fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldType,
...
// OrderOption defines the ordering options for the SoftwareDefinition queries.
